...
# api key on 22/04/2022 - e509c8445d241d50639adff6f3c6cda0
...
def trackBitcoin():   #funtion to stalk creepy-crypto
    url = "http://api.coinlayer.com/api/live?access_key=e509c8445d241d50639adff6f3c6cda0&symbols=BTC,ETH,DOGE"
    ...
    window.after(5000, trackBitcoin)
...
# pyinstaller --add-data "*.png;." --onefile 'crypto.py